...
class StarFoxConfigSurfaceTests(unittest.TestCase):
    ...
    def test_enhanced_renderer_is_explicitly_opt_in(self):
        ...
        self.assertIn("kNativeWorldMinDrawObjects = 4", renderer_c)
        self.assertIn("kNativeWorldMinDrawnShapes = 2", renderer_c)
        self.assertIn("kNativeWorldMinVisiblePixels = 1024", renderer_c)
        ...
        self.assertIn("subtract16(g_source_snapshot.shadow_height, g_source_snapshot.view_y)", renderer_c)
        ...
        self.assertIn("g_source_snapshot.unsupported_text != 0", renderer_c)
        ...
        self.assertIn("frame->widescreen_extra, native_world_ready ? 1 : 0", renderer_c)
        self.assertIn("if (!native_ppu_done && !native_world_ready)", renderer_c)
        self.assertIn("if (native_world_ready)", renderer_c)
