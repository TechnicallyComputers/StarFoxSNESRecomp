...
class StarFoxConfigSurfaceTests(unittest.TestCase):
    ...
    def test_enhanced_renderer_is_explicitly_opt_in(self):
        ...
        self.assertIn("update_native_world_replacement(native_world_ready)", renderer_c)
        ...
        self.assertIn("if (!native_ppu_done && !suppress_superfx_world_bg1)", renderer_c)
        self.assertIn("if (suppress_superfx_world_bg1)", renderer_c)
